                ...
                {rhfFromUnit && rhfToUnit && (
                  <div className="flex flex-wrap items-center gap-2">
                    <FxSparkline
                      ...
                      to={rhfToUnit}
                      className="h-10"
                      linkUrl={currentConversionPairUrl ? `${currentConversionPairUrl}#converter` : undefined}
                    />
                  </div>
                )}
              </div>
  ...
  <>
    <GlobalStyles />
      ...
      <Card
        id="converter"
        className={cn(
          "relative flex h-full w-full flex-col overflow-visible rounded-2xl",
          "border border-transparent bg-transparent shadow-none",
          "sm:border-border/60 sm:bg-card/90 sm:shadow-lg sm:backdrop-blur-sm",
          className
        )}
        aria-labelledby="unit-converter-title"
      >
        <CardContent className={cn("flex flex-grow flex-col px-2 pt-3 pb-3 bg-transparent sm:px-4 sm:py-5")}>
